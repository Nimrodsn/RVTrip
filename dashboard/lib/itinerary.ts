...
export const itinerary: Itinerary = {
  ...
  locations: [
    ...
    { day: 4, name: "Demänovská Ice Cave", type: "attraction", coords: { lat: 49.0029, lng: 19.5828 }, note: "Afternoon tour on the way in. Around 0°C inside all summer, so warm layers and long trousers. Uphill walk to the entrance.", url: "https://www.ssj.sk/en/jaskyna/5-demanovska-ice-cave" },
    { day: 4, name: "Liptovský Mikuláš - Tesco Extra", type: "supply", coords: { lat: 49.079, lng: 19.613 }, note: "Huge parking, open 24/7. Shop after the cave so nothing sits warm in a parked RV.", url: "https://tesco.sk/" },
    ...
    { day: 5, name: "Rafting Centre Liptovský Mikuláš", type: "attraction", coords: { lat: 49.0768, lng: 19.6083 }, note: "Guided family rafting on the Váh slalom channel, ~1h30. Runs outside athlete training, usually from 12:00, so book by phone first (+421 948 906 506). Min age 10 and everyone must swim. Wetsuit, neoprene boots, helmet and vest provided; bring swimwear, towels and a full change of dry clothes from the RV garage.", url: "https://www.mikulas.sk/en/visitor/sport-in-the-town/ondrej-cibak-area-of-water-slalom" },
    { day: 5, name: "Aquapark Tatralandia", type: "attraction", coords: { lat: 49.1067, lng: 19.5699 }, note: "Thermal water park, ~15 min from the rafting channel. Afternoon and evening once everyone is dry.", url: "https://www.tatralandia.sk/en/welcome" },
    { day: 6, name: "Treetop Walk Bachledka", type: "attraction", coords: { lat: 49.277494, lng: 20.308253 }, note: "~1h25 from Liptov. Treetop walk over the Belianske Tatras with an observation tower and a long dry toboggan. Long trousers required for the slide.", url: "https://bachledka.sk/" },
    { day: 6, name: "Autocamping Betlanovce", type: "campsite", coords: { lat: 48.9820995, lng: 20.3873466 }, note: "~50 min from Bachledka. Betlanovce 130, 053 15. Base for northern Slovak Paradise." },
